...
import { createProductPage, createProducts, deleteProduct, getProductByCatagoery, getProductDetails, getProducts, removeImageFromProduct, searchProduct, updateProduct, updateProductPage } from "../../controllers/products/index.js";
import multer from "multer";
import fs from 'fs';
import { ADMIN_CREATE_PRODUCTS, ADMIN_DELETE_PRODUCTS, ADMIN_PRODUCT_DETAILS, ADMIN_PRODUCT_IMAGE_REMOVE, ADMIN_PRODUCT_LIST, ADMIN_PRODUCT_SEARCH, ADMIN_UPDATE_PRODUCTS, PRODUCTS_BY_ID } from "../../constans/endpoints.js";
